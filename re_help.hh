...
"   [1]REF-EVAL-BUILD-TRUE-ASSEMBLY. Alternatively, you can use the\n"
...
"\n"
"                Otherwise, columns 2 and 3 contain \"NA\". For precision,\n"
"                the file has the same format, but with the reference and\n"
"                the assembly interchanged. In other words, each row\n"
"                corresponds to a contig $a$ and contains information\n"
"                about its matching to a reference sequence $b$, or all\n"
...
"\n"
"   Visible links\n"
"   1. http://deweylab.biostat.wisc.edu/detonate/ref-eval-build-true-assembly.html\n"
