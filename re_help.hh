...
"   Blat [1]. We recommend fairly unrestrictive settings, in order to\n"
...
"   RSEM-EVAL) to compute the expression of the assembly and reference\n"
...
"   $tau(b) = 1/|B|$ for all $b$ in $B$, where $|A|$ is the number of\n"
