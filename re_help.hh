...
"\n"
"                Otherwise, columns 2--4 contain \"NA\". For precision, the\n"
"                file has the same format, but with the reference and the\n"
"                assembly interchanged. In other words, each row\n"
